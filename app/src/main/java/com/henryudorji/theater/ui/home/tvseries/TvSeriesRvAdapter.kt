...
class TvSeriesRvAdapter(): RecyclerView.Adapter<TvSeriesRvAdapter.TvSeriesViewHolder>() {

    inner class TvSeriesViewHolder(val binding: RvMovieLayoutBinding): RecyclerView.ViewHolder(binding.root)
